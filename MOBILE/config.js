...
// Semua metadata DEX (label, badge, warna, icon, count, enabled)
// bersumber di sini — tidak hardcode di JS maupun CSS
// ============================================================
const CONFIG_DEX = {
  ...
  // ── DEX LANGSUNG (sumber: 2 provider paralel, ambil terbaik) ─
  kyber: {
    label:      'KYBER',
    badge:      'KB',
    color:      '#087808ff',
