...
const CONFIG_CHAINS = {
    bsc: {
        ...
        DEXS: ["kyber", "okx", "matcha", "oneinch", "sushi", "velora", "flytrade", "odos"],  // ✅ lifidex = standalone LIFI (via Temple API)
        WALLET_CEX: {
    ...
    arbitrum: {
        ...
        DEXS: ["kyber", "okx", "matcha", "oneinch", "sushi", "velora", "flytrade", "odos"],
        WALLET_CEX: {
